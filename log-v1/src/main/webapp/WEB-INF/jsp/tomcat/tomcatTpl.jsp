...
<div class="container-fluid">
	...
	<div class="col-md-2" style="padding-top: 10px;">
        <div class="list-group">
             <a href="${pageContext.request.contextPath}/tomcat/tomcatTpl" class="list-group-item active">Tomcat分析</a>
...
<script type="text/javascript">
	...
	function _search(){
		...
		MECHART.displayChart(bar_parent_chart,"${pageContext.request.contextPath}/tomcat/geoIpStatistics",params);
		bar_parent_chart.on('click', function(params){
			 ...
			 if( $('#ii_container').hasClass("show")&& $('#iii_container').hasClass("show")){
				  ...
				  MECHART.displayChart(bar_i_chart,"${pageContext.request.contextPath}/tomcat/dateHisgramStatistics",params);
				  bar_i_chart.on('click', function(params){
					  ...
					  if((params.name).endsWith("秒")){
						  ...
						  MDialog.show('${pageContext.request.contextPath}/tomcat/sDetailInfo?'+paramStr);
						  return;
					  }
				  ...
				  if($('#analysisType').val() == 'errorPage'){
				  		<!--错误统统计-->
				  		MECHART.displayChart(chart_common_i,"${pageContext.request.contextPath}/tomcat/wrongPageStatistics",params);
				  		chart_common_i.on('click', function(params){
							 ...
							 var chart_common_ii = MECHART.initChart("chart_common_ii");
				  			 MECHART.displayChart(chart_common_ii,"${pageContext.request.contextPath}/tomcat/errorStatusStatistics",params);
				  			 chart_common_ii.on('click', function(params){
							    ...
							    var paramStr = $('#sform').serialize();
							    MDialog.show('${pageContext.request.contextPath}/tomcat/detailInfo?'+paramStr);
				  			});
				  		});  
				  }else if($('#analysisType').val() == 'responseTime'){
					    <!--页面处理时间排名-->
					    MECHART.displayChart(chart_common_i,"${pageContext.request.contextPath}/tomcat/pageProcessTimeRank",params);
					    chart_common_i.on('click', function(params){
					   ...
					   if(params.name=="平均值"){
					    ...
					    <!--页面访问频次统计-->
					    MECHART.displayChart(chart_common_i,"${pageContext.request.contextPath}/tomcat/pageAccessFrequentlyStatistics",params);
					    chart_common_i.on('click', function(params){
	...
	function _analysis() {
		...
		MECHART.displayChart(bar_ii_chart,"${pageContext.request.contextPath}/tomcat/pageCompareAnalysis",params);
    }
</script>
</body>
</html>